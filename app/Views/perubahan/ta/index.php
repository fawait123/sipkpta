    ...
    <?php if (($sekarang >= $start2) && ($sekarang <= $end2)) { ?>
        <?php if ($pengajuan !== null) : ?>
            <?php if ($pengajuan->no_perubahan == null || $pengajuan->no_perubahan == "") : ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('perubahan/ta') ?>" method="post" enctype="multipart/form-data" id="form-perubahan-ta">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-body">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">Proposal : <a href="<?= base_url('uploads/perubahan/tugas akhir/' . $perubahan->npm . '-' . $perubahan->nama_mahasiswa . '/' . $perubahan->proposal) ?>" target="blannk"><?= $perubahan->proposal ?> &nbsp; <i class="fa fa-file-pdf"></i></a></li>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <?php if ($perubahan->status_dosen == 'revisi') : ?>
                                        <div class="timeline-footer">
                                            <form action="<?= base_url('perubahan/revisi-ta') ?>" method="post" enctype="multipart/form-data" id="form-revisi-proposal-mahasiswa">
        ...
        <?php else : ?>
            <div class="alert alert-info alert-dismissible">
                ...
                <br>
                <ul>
                    <li>Anda tidak di ijinkan mengakses perubahan judul tugas akhir</li>
                </ul>
            </div>
        <?php endif; ?>
    <?php } else { ?>
        <?php if ($pengajuan !== null) : ?>
            ...
            <?php else : ?>
                <div class="alert alert-info alert-dismissible">
                    ...
                    <br>
                    <ul>
                        <li>Pastikan anda sudah terdaftar pada matakuliah tugas akhir</li>
            ...
            <tbody>
                ...
                foreach ($perubahan as $p) : ?>
                    <tr>
                        ...
                        <td><a href="<?= base_url('uploads/perubahan/tugas akhir/' . $p->npm . '-' . $p->nama_mahasiswa . '/' . $p->proposal) ?>" target="blank"><?= $p->proposal ?> &nbsp;<i class="fa fa-file-pdf"></i></a></td>
...
<?php endif; ?>
<!-- modal reviwe dosen -->
<form action="<?= base_url('perubahan/review-perubahan-dosen-ta') ?>" method="post">
...
<!-- modal reviwe prodi -->
<form action="<?= base_url('perubahan/review-perubahan-prodi-ta') ?>" method="post">
