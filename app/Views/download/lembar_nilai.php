...
<table align="center" width="700">
    <tr>
        <th colspan="2">
            LEMBAR REVIEW PROPOSAL KP<br>
            <br>
        </th>
    </tr>
    <tr>
        <td colspan="5">Pada hari ini Jumat, 25 Maret 2022 dilaksanakan Seminar Kerja Praktik bagi Mahasiswa :</td>
    </tr>
    <tr>
...
<table border="1" width="700" align="center" style="margin-top: 40px;">
    <tr>
        <td style="padding: 5px; text-align: center;" colspan="3">Nilai Kerja Praktik</td>
    </tr>
    <tr>
...
<table width="200" align="left" style="margin-left: 24%; margin-top: 20px;">
    <tr>
        <td style="text-align: center;">Tanda Tangan Pembimbing</td>
    </tr>
    <tr>
        <td style="padding-top: 80px; text-align:center"><?= $detail->nama_dosen ?></td>
    </tr>
</table>
            ...
            <ol>
                    ...
                    <ol type="a">
                        ...
                        <li>
                            ...
                            <ol type="i">
                                ...
                                <li>Kesimpulan dari Kerja Praktik yang dibuat.</li>
                            </ol>
                        </li>
                    </ol>
                </li>
                ...
                <li>
                    ...
                    <ol type="a">
                        ...
                        <li>Bobot materi Kerja Praktik.</li>
                    </ol>
                </li>
            </ol>
        </td>
