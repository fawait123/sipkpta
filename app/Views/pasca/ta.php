...
<?php if ($check && $check->tempat != null): ?>
    ...
    <?php if ($penutupan >= $sekarang && $sekarang <= $penutupan): ?>
        <?php if ($row): ?>
            <div class="alert alert-primary" role="alert">
                <ul>
                    ...
                    <li>Pendaftaran pasca pendadaran tugas akhir ditutup
                        pada <?= Utils::addDate($check->tgl, 51) ?></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="col-6">
                                            <ul class="list-group">
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Abstrak) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;
                                                        Abstrak</a></li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Daftar_Pustaka) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Naskah</a>
                                                </li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Laporan_TA) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Database</a>
                                                </li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Lembar_Pengesahan) ?>"
                                                            target="blank"><i
                                                                class="fa fa-file"></i>&nbsp;&nbsp;Infografis
                                                        Editable</a></li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Naskah_Publikasi) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Infografis
                                                        Non
                                                        Editable</a></li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Program) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a>
                                                </li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Database) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a>
                                                </li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Infografis_e) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a>
                                                </li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Infografis_n_e) ?>"
                                                            target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a>
                                                </li>
                                            </ul>
                                        </div>
        ...
        <?php else: ?>
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('pasca/kerjapraktik') ?>" method="POST" enctype="multipart/form-data"
                          id="form-store">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="lembar_pengesahan"
                                   placeholder="Lembar Pengesahan"/>
                        </div>
                        <div class="form-group">
                            <label for="Naskah Publikasi">Naskah Publikasi</label>
                            <input type="file" class="form-control" name="naskah_publikasi"
                                   placeholder="Naskah Publikasi"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="infografis_e"
                                   placeholder="Inforgrafis Editable"/>
                        </div>
                        <div class="form-group">
                            <label for="Infografis Non Editable">Infografis Non Editable</label>
                            <input type="file" class="form-control" name="infografis_n_e"
                                   placeholder="Infografis Non Editable"/>
                ...
                $("#form-store").validate({
                    ...
                    messages: {
                        abstrak: {
                            ...
                            extension: "File Abstrak extensi PDF"
                        },
                        daftar_pustaka: {
                            required: "Inputan Daftar Pustaka tidak boleh kosong",
                            extension: "File Daftar Pustaka extensi PDF"
                        },
                        laporan_ta: {
                        ...
                        lembar_pengesahan: {
                            ...
                            extension: "File Lembar Pengesahan PDF"
                        },
                        naskah_publikasi: {
                            required: 'Inputan Naskah Publikasi tidak boleh kosong',
                            extension: "File Naskah Publikasi extensi PDF"
                        },
                        program: {
                            required: 'Inputan Program tidak boleh kosong',
                            extension: "File Program extensi ZIP | RAR"
                        },
                        database: {
                            required: 'Inputan Database tidak boleh kosong',
                            extension: "File Database extensi SQL"
                        },
                        infografis_e: {
                            required: 'Inputan Infografis Editable tidak boleh kosong',
                            extension: "File Infografis Editable extensi DOC | DOCX"
                        },
                        infografis_n_e: {
                            required: 'Inputan Infografis Non Editable tidak boleh kosong',
                            extension: "File Infografis Non Editable extensi PDF"
                        }
                    },
                    errorElement: 'span',
