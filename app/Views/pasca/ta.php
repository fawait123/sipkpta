...
?>
        <?php if($row): ?>
            <div class="alert alert-primary" role="alert">
                Terimakasih anda sudah melengkapi data pasca tugas akhir
            </div>
            <div class="row">
          <div class="col-md-12">
            <!-- The time line -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Daftar_Pustaka)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Naskah</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Laporan_TA)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Database</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Lembar_Pengesahan)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Infografis Editable</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Naskah_Publikasi)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Infografis Non Editable</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Program)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Database)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Infografis_e)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a></li>
                                <li class="list-group-item"><a href="<?=DriveApi::getFile($row->Infografis_n_e)?>" target="blank"><i class="fa fa-file"></i>&nbsp;&nbsp;Program</a></li>
                            </ul>
                        </div>
                    </div>
                  </div>
