...
<?php if ($check): ?>
    ...
    <?php if ($penutupan >= $sekarang && $sekarang <= $penutupan): ?>
        <?php if ($row): ?>
            <div class="alert alert-primary" role="alert">
                <ul>
                    <li>Terimakasih anda sudah melengkapi data pasca seminar kerja praktik</li>
                    <li>Pendaftaran pasca seminar kerja praktik ditutup pada <?= Utils::addDate($check->tgl, 51) ?></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                                        ...
                                        <div class="col-6">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item"><a
                                                        ...
                                                        Abstrak</a></li>
                                                <li class="list-group-item"><a
                                                            href="<?= DriveApi::getFile($row->Naskah) ?>"
    ...
    <?php else : ?>
        <?php if ($row): ?>
            <div class="alert alert-primary" role="alert">
                <ul>
                    <li>Terimakasih anda sudah melengkapi data pasca kerja praktik</li>
                    <li>Pendaftaran pasca seminar kerja praktik ditutup pada <?= Utils::addDate($check->tgl, 51) ?></li>
                </ul>
            </div>
            <div class="row">
...
<?php else: ?>
    <div class="card">
        <div class="card-body">
            <div class="alert alert-primary" role="alert">
                <ul>
                    <li>Anda tidak punya akses halaman pasca seminar kerja praktik</li>
                    <li>pastikan anda sudah terdaftar seminar kerja praktik</li>
                </ul>
            </div>
        </div>
    </div>
